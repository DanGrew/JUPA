...
/**
 * The {@link JsonKeyHandler} provides a handler for reading keys from a JSON stream. 
 ...
 */
public class JsonKeyHandler< HandledTypeT > implements JsonKeyHandle< HandledTypeT >{
   ...
   /** 
    * Constructs a new {@link JsonKeyHandler}.
