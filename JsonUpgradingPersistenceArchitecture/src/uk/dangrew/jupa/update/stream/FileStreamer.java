...
/**
 * The {@link FileStreamer} is responsible for streaming a file from a download
...
public class FileStreamer {
    ...
    */
   FileStreamer( HttpClient client, FileStreamerDigest digest, IoStreaming streamer ) {
      this.digest = digest;
    ...
    */
   public void streamFile( String downloadLink, JarProtocol fileProtocol ) throws IOException  {
      if ( 
